...
|     |                                                                                                                                                                                                                                                                                                                                                                     |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     | This document lists keyboard shortcuts for [arlbibek/windows-ahk](https://github.com/arlbibek/windows-ahk), a simple and intuitive AutoHotKey script to enhance your Windows workflow. <br/>For setup instructions, refer to the [README.md](https://github.com/arlbibek/windows-ahk#readme) on GitHub. <br/>Made with ❤️ by [Bibek Aryal](https://bibeka.com.np/). |
...
| Presentation mode        | Toggle **Presentation Mode** where Windows supports it; on editions such as **Home** (where Presentation Settings is unavailable), the same action uses **stay-awake** mode via the system so the PC does not idle-sleep while the script runs.                                                                                                                                             | Win + Shift + P         |
| Keyboard shortcuts       | View keyboard shortcuts, opens (this) shortcut documentation as a PDF                                                                                                                                                                                                                                                                                                                       | Ctrl + Shift + Alt + \\ |
| Show launch notification | Enable or disable startup tray notification                                                                                                                                                                                                                                                                                                                                                 |                         |
| Open file location       | Opens the script directory                                                                                                                                                                                                                                                                                                                                                                  |                         |
| Preferences              | Open the launch configuration dashboard (also: **single left-click** the tray icon)                                                                                                                                                                                                                                                                                                         | Alt + F1                |
| Check for updates        | Checks GitHub Releases for a newer version                                                                                                                                                                                                                                                                                                                                                  |                         |
| Install update           | Downloads and launches the latest installer when an update is available                                                                                                                                                                                                                                                                                                                     |                         |
| Windows Utilities        | Launch [Microsoft Activation Scripts](https://github.com/massgravel/massgrave.dev), [Chris Titus Tech Windows Utility](https://github.com/ChrisTitusTech/winutil), or [Network adapter switch (nadap-switch)](https://github.com/arlbibek/nadap-switch). _These tools are provided as-is for convenience. We do not accept any liability for how these scripts are used or their outcomes._ |                         |
...
| `/date`                           | May 13, 2025                                                            |
| `/time`                           | 17:38                                                                   |
| `/epoch`, `/unix`, or `/unixtime` | Unix time in **UTC seconds** since 1970-01-01 (same epoch as most APIs) |
