...
| <kbd>F7</kbd>                                      | Open or switch to Microsoft Word (Use <kbd>Shift</kbd> to open a new window)                                                                                          |
| <kbd>F8</kbd>                                      | Open or switch to Microsoft Excel (Use <kbd>Shift</kbd> to open a new window)                                                                                         |
| <kbd>F10</kbd>                                     | Open or switch to PowerShell (If File Explorer is active, PowerShell will open in the current directory) (Use <kbd>Shift</kbd> + <kbd>F10</kbd> to open a new window) |
...
| <kbd>Win</kbd> + <kbd>Shift</kbd> + <kbd>S</kbd>   | Search the contents of the clipboard using the active or default browser                                                                                              |
| <kbd>Win</kbd> + <kbd>C</kbd>                      | Center the current window                                                                                                                                             |
| <kbd>Win</kbd> + <kbd>Shift</kbd> + <kbd>P</kbd>   | Toggle presentation mode on or off                                                                                                                                    |
| <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>c</kbd>    | Copy text without new lines (useful for copying text from a PDF file)                                                                                                 |
